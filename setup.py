...
setup( 
    ...
    url = 'https://github.com/saburbutt/linkedin_scraper', # use the URL to the github repo 
    download_url = 'https://github.com/saburbutt/linkedin_scraper/dist/' + version + '.tar.gz', 
